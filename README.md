...
<div data-importer="profile-views" align="center">
  <img data-importer="profile-views" src="https://visitor-badge.laobi.icu/badge?page_id=IamIshan07.IamIshan07&"  />
</div>
...
<p data-importer="text" align="left">🎓 I am Ishan Kar, a Software Engineer from West Bengal. Focused on writing efficient code, structuring scalable layouts.<br><br>⚡ Actively practicing Data Structures and Algorithms to build a strong foundation in core problem-solving logic.<br><br>⚡ Building clean, responsive, and interactive user interfaces using modern HTML, CSS, JavaScript and JS frameworks.<br><br>⚡ Developing foundational skills in frontend layouts, styles, and web structure.<br><br>⚡ Preparing to transition into full-stack development technologies in the near future.</p>
